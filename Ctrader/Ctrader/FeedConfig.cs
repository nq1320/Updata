...
namespace Ctrader
{
	...
	{
		/// <summary>The unique FeedName is CTRADER</summary>		
		public static string FeedName() { return "CTRADER"; }
		/// <summary>The readable FeedName is Ctrader</summary>		
		public static string Name() { return "Ctrader"; }
		/// <summary>The Data Source Description is Ctrader</summary>		
		public static string Source() { return "Ctrader"; }
		/// <summary>The Module output is CTRADER.dll</summary>		
		public static string Module() { return "CTRADER.dll"; }
