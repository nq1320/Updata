...
namespace Bytbit
{
	...
	public class Bytbit : UAPI.UAPI
	{
		...
		/// </summary>
		public static Bytbit I { get; private set; } = null;
		...
		/// This dialog is displayed in the <see cref="Bytbit.SettingsDialog"/> override below. 
		/// </summary>
		Settings Settings = new Settings();

		#region Setup

		public Bytbit() : base(FeedConfig.FeedName())
		{
			I = this;
