...
namespace Bytbit
{
	...
	public partial class Settings : Form
	{
		...
		/// This flag is set when the dialog should be destroyed <see cref="Bytbit.Shutdown"/>
		/// </summary>
		...
		private void Settings_Load(object sender, EventArgs e)
		{
			try
			{
				...
				tsVersion.Text = string.Format("Version {0}", Bytbit.I.Version);
